...
function nirvana_frontpage_generator() {
	...
	<div id="frontpage">
		...
		if ($nirvana_fronttext1 || $nirvana_fronttext3) { ?><div id="pp-texttop"><?php
			...
			if ($nirvana_fronttext3) {?><div id="front-text3" class="ppbox"> <?php echo force_balance_tags( do_shortcode($nirvana_fronttext3) ) ?></div><?php } 
		?></div><?php }
		...
		if ($nirvana_fronttext2 || $nirvana_fronttext4) {?><div id="pp-textmiddle"><?php
			...
			if($nirvana_fronttext4) {?><div id="front-text4" class="ppbox"> <?php echo force_balance_tags( do_shortcode($nirvana_fronttext4) ) ?> </div><?php } 
		?></div><?php }
		...
		if ($nirvana_fronttext5 || $nirvana_fronttext6) { ?><div id="pp-textbottom"><?php
			...
			if ($nirvana_fronttext6) {?><div id="front-text6" class="ppbox"> <?php echo force_balance_tags( do_shortcode($nirvana_fronttext6) ) ?></div><?php }
		?></div><?php } ?>
